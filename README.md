print("https://youtube.com/@anyone_inworld?si=JtpemI_mFCHvSoU1")
toclipboard("https://youtube.com/@anyone_inworld?si=JtpemI_mFCHvSoU1")
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("God Hub Premium Scripts") then
			makefolder("God Hub Premium Scripts")
		end
		if not isfolder("God Hub Premium Scripts/Blox Fruits/") then
			makefolder("God Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("God Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("God Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("

 Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("God Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("God Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
			local Array = {}
			for i,v in pairs(_G.Settings) do
				Array[i] = v
			end
			writefile("God Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
if QuestC.Visible == true then
						...
						local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/minhhau207/GodHub/main/obfuscated-3788.lua"))()
